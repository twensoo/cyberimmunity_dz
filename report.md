...
|-----------------------------------------------|---------------------------------------------|------------------------------------------|
| **1.Связь**                                   |🌕 доверенный, повышающий целостность данных | Этот компонент отвечает за распределение задач транспорта, критичен ЦБ(Внутри содержатся группы доверенных и недоверенных компонентов, связанных друг с другом, по итогу взаимодействия которых *на выход идут достоверные данные*) |
