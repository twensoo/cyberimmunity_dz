...
| **10. Приводы**                               |🌕 доверенный, повышающий целостность данных | Влияет на осуществление перевозки пассажиров, нурашая ЦБ-1. Разбит на несколько модулей с разным уровнем доверия |
| **11. Система координирования транспорта**    |🌕 доверенный, повышающий целостность данных | Анализ, полученных данных. Получает данные из двух источников, анализируя, и тщательно проверяя - выдает достоверные данные для (6), влияет на ЦБ-1,2,3 |
